...
from app_hierarchy.command import CurrentAppResponse
from app_hierarchy.base_driver import BaseDriver, Node, AppInfo, Rect, ShellResponse, WindowSize
from app_hierarchy.exceptions import AndroidDriverException, RequestError
# from utils.common import fetch_through_socket
...
def parse_xml_element(element: ElementTree.Element, wsize: WindowSize, display_id: Optional[int], indexes: List[int] = [0]) -> Optional[Node]:
    """
